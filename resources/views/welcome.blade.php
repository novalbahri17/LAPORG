...
<head>
    ...
    <title>RW10Lapor | Laporan Masyarakat</title>
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                        <p>
                        <h3>RW10Lapor</h3> adalah sistem laporan pengaduan Masyarakat yang dibuat untuk memudahkan
                        Masyarakat untuk memberikan laporan atau informasi kepada pihak petugas desa
                        </p>
                        <ul>
                            <h3>Tujuan RW10Lapor</h3>
                    ...
                    <div class="pt-4 col-lg-6 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <p>
                        <h4></h4>merupakan komitmen kami untuk melayani Masyarakat. Dengan hadirnya sistem
                        pelaporan pengaduan online ini, diharapkan setiap suara Masyarakat bisa didengar dan
                        ditindaklanjuti oleh pihak desa.
                        </p>
        ...
        <section id="counts" class="counts">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="pt-4 col-xl-7 d-flex align-items-stretch pt-xl-0" data-aos="fade-left"
                        data-aos-delay="300">
                            ...
                            <div class="row">
                                <div class="col-md-6 d-md-flex align-items-md-stretch">
                                    <div class="count-box">
                                        ...
                                        <p><strong>Pengguna</strong><br>DAFTAR pengguna RW10Lapor</p>
                                    </div>
                                </div>
