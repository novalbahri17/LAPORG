...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block">
  <div class="py-4 text-gray-500 dark:text-gray-400">
      <img src="{{ asset('img/logo.svg') }}" alt=""
          class="inline-flex items-center ml-3 transition duration-300 ease-in-out transform hover:scale-125" />
...
<!-- Mobile Sidebar -->
<aside 
  class="fixed inset-y-0 z-20 flex-shrink-0 w-64 overflow-y-auto bg-white dark:bg-gray-800"
  x-show="isSideMenuOpen" 
  x-transition:enter="transition ease-in-out duration-150"
  ...
  <div class="py-4 text-gray-500 dark:text-gray-400">
      ...
      <div class="flex items-center px-6 mb-4">
          <img src="{{ asset('img/logo.svg') }}" alt="Logo" class="w-8 h-8 mr-3">
          <span class="text-lg font-bold text-gray-800 dark:text-gray-200">RW10Lapor</span>
      </div>
      ...
      <ul>
          ...
          <li class="relative px-6 py-3">
              <a href="{{ route('dashboard') }}"
                 class="inline-flex items-center w-full text-sm font-semibold text-gray-700 transition-colors duration-150 hover:text-gray-800 dark:text-gray-200">
                  <svg class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
